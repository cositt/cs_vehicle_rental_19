...
# Part of TechKhedut. See LICENSE file for full copyright and licensing details.
{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            # COMENTADO TEMPORALMENTE POR CONFLICTO IFRAME: 'vehicle_rental/static/src/js/lib/apexcharts.js',
            # COMENTADO TEMPORALMENTE POR CONFLICTO IFRAME: 'vehicle_rental/static/src/js/lib/xy.js',
            # COMENTADO TEMPORALMENTE POR CONFLICTO IFRAME: 'vehicle_rental/static/src/js/lib/index.js',
            # COMENTADO TEMPORALMENTE POR CONFLICTO IFRAME: 'vehicle_rental/static/src/js/lib/Animated.js',
            # COMENTADO TEMPORALMENTE POR CONFLICTO IFRAME: 'vehicle_rental/static/src/js/lib/dhtmlxgantt.css',
