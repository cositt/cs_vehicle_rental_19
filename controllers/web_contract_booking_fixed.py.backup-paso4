                ...
                <script>
                        ...
                        function displayVehicles(vehicles) {{
                            ...
                            vehicles.forEach(vehicle => {{
                                // Extraer marca del nombre del vehículo
                                const brandName = vehicle.name.split(' ')[0]; // Primera palabra del nombre
                                const vehicleName = vehicle.name.replace(brandName + ' ', ''); // Resto del nombre
                                
                                // Determinar imagen de marca
                                let brandImage = self._get_image_path('default');
                                if (brandName.toLowerCase() === 'ford') {{
                                    brandImage = '/vehicle_rental/static/description/img/marcas/ford.svg';
                                }} else if (brandName.toLowerCase() === 'iveco') {{
                                    brandImage = '/vehicle_rental/static/description/img/marcas/iveco.svg';
                                }} else if (brandName.toLowerCase() === 'mercedes-benz') {{
                                    brandImage = '/vehicle_rental/static/description/img/marcas/mercedes.svg';
                                }} else if (brandName.toLowerCase() === 'renault') {{
                                    brandImage = '/vehicle_rental/static/description/img/marcas/renault.svg';
                                }} else if (brandName.toLowerCase() === 'volkswagen') {{
                                    brandImage = '/vehicle_rental/static/description/img/marcas/volkswagen.svg';
                                }}
                                ...
                                vehicleCard.innerHTML = `
                                    <div class="card h-100 vehicle-card" style="cursor: pointer;" onclick="selectVehicle(${{vehicle.id}}, '${{vehicle.name}}', '${{vehicle.license_plate}}')">
                                        <div class="card-body text-center">
                                            <img src="${{brandImage}}" class="card-img-top mb-3" style="height: 120px; object-fit: contain;" alt="${{brandName}}">
