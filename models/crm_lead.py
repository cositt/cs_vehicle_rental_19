...
class BookingEnquiryLead(models.Model):
    ...
    customer_address = fields.Char(string="Domicilio", help="Dirección del cliente")
    driver_license_number = fields.Char(string="Carnet de Conducir", help="Número del permiso de conducir")
    driver_license_issue_date = fields.Date(string="Fecha Expedición Carnet", help="Fecha de expedición del carnet de conducir")
    driver_license_expiry_date = fields.Date(string="Fecha Caducidad Carnet", help="Fecha de caducidad del carnet de conducir")
    birth_date = fields.Date(string="Fecha de Nacimiento", help="Fecha de nacimiento del cliente")
